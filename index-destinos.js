const DESTINOS_INDEX = [
  { pais: "Colombia", precio: "$650",  emoji: "🏔️" },
  { pais: "Peru",     precio: "$780",  emoji: "🦙" },
  { pais: "Spain",    precio: "$1,100",emoji: "💃" },
  { pais: "Thailand", precio: "$1,400",emoji: "🐘" },
];
...
function crearTarjetaDestino(data, extra) {
  ...
  const foto    = `https://source.unsplash.com/400x260/?${encodeURIComponent(nombre)},travel`;
